...
public class ElasticSearchQuery {
    ...
    public List<Trade> findOrders(String product) throws  IOException {
    ...
    public Stream<Trade> findOrders(String product, String side, String orderType) throws IOException {
        System.out.println("Side is  " + side);
        System.out.println("Product is  " + product);
        System.out.println("Product name on Elasticsearch is  " + getIndexByTicker(product));
        SearchRequest searchRequest = SearchRequest.of(s -> s
    ...
    public Stream<Trade> findOrders(String product, String side, String orderType, String exchangeUrl) throws IOException {
        System.out.println("Side is  " + side);
        System.out.println("Product is  " + product);
        System.out.println("Product name on Elasticsearch is  " + getIndexByTicker(product));
        SearchRequest searchRequest = SearchRequest.of(s -> s
